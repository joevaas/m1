...
from config import API_HASH, API_ID, LOGGER, BOT_TOKEN, TG_BOT_WORKERS, FORCE_SUB_CHANNEL_1, FORCE_SUB_CHANNEL_2, CHANNEL_ID, PORT, FORCE_SUB_CHANNEL_3, FORCE_SUB_CHANNEL_4
    ...
    async def start(self):
        ...
        if FORCE_SUB_CHANNEL_1:
            try:
                ...
                self.LOGGER(__name__).warning(f"Please Double Check The FORCE_SUB_CHANNEL Value And Make Sure Bot Is Admin In Channel With Invite Users Via Link Permission, Current Force Sub Channel Value: {FORCE_SUB_CHANNEL_1}")
